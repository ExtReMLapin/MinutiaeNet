...
def get_has_correct_angle(manually_extracted_angle, extracted_angle):
    ...
    found_manually_extracted_angle = get_formatted_angle(
        manually_extracted_angle)

    angles_difference = abs(
        found_manually_extracted_angle - formatted_extracted_angle)
...
def get_is_extracted_correctly(extracted_item, manually_extracted, radius, check_angle=False):
    ...
    for manually_extracted_item in manually_extracted.minutiae_data:
        ...
        has_correct_angle = get_has_correct_angle(
            manually_extracted_item.theta, extracted_item[2]) if check_angle else True
...
def get_correctly_extracted_items(manually_extracted, extracted, radiuses):
    ...
    for radius in radiuses:
        ...
        correctly_extracted_angle_by_radius.append(
            correctly_extracted_items_angle)
...
extracted = get_extracted_minutiae(
...
for extracted_file in extracted:
    ...
    sum_25_not_extracted_from_manually_extracted_angle += relative_values[
        'output_values_with_angle'][2]['not_extracted_from_manually_extracted']
